...
public class CsaTradeDtccRdsHarmonizedReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_CSATradeReportToDtccRdsHarmonized> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_CSATradeReportToDtccRdsHarmonized.class)

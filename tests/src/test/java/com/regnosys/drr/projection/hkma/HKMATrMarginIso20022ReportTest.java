...
public class HKMATrMarginIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_HKMATrMarginReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_HKMATrMarginReportToIso20022.class)
                    .withSchemaValidation(Resources.getResource(Auth108HkmaTrModelConfig.SCHEMA_PATH));

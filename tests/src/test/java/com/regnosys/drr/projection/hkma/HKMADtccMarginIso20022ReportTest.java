...
public class HKMADtccMarginIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_HKMADtccMarginReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_HKMADtccMarginReportToIso20022.class)
                    .withSchemaValidation(Resources.getResource(Auth108HkmaDtccModelConfig.SCHEMA_PATH));

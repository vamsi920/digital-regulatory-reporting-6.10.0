...
public class HKMADtccTradeIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_HKMADtccTradeReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_HKMADtccTradeReportToIso20022.class)

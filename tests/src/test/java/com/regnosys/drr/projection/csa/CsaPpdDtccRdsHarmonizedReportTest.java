...
public class CsaPpdDtccRdsHarmonizedReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_CsaPpdReportToDtccRdsHarmonized> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_CsaPpdReportToDtccRdsHarmonized.class)

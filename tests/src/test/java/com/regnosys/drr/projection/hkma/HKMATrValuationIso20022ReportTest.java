...
public class HKMATrValuationIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_HKMATrValuationReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_HKMATrValuationReportToIso20022.class)
                    .withSchemaValidation(Resources.getResource(Auth030HkmaTrModelConfig.SCHEMA_PATH));

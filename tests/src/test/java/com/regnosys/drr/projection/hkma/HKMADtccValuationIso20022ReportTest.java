...
public class HKMADtccValuationIso20022ReportTest {
    @RegisterExtension
    static TransformTestExtension<Project_HKMADtccValuationReportToIso20022> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    PROJECTION_CONFIG_PATH_WITHOUT_ISO20022,
                    Project_HKMADtccValuationReportToIso20022.class)
